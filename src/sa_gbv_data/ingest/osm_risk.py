...
def ingest(south: float, west: float, north: float, east: float, output: Path, endpoint: str = DEFAULT_ENDPOINT) -> gpd.GeoDataFrame:
...
def main() -> None:
    ...
    ingest(args.south, args.west, args.north, args.east, args.output)
